...
const ROLES = [
  ...
  { id:'fox',            name:'Cáo',                  icon:'🦊',  team:'village' },
  { id:'gravedigger',    name:'Người Gác Mộ',          icon:'⚰️', team:'village' },
  { id:'detective',      name:'Thám Tử',              icon:'🕵️', team:'village' },
  { id:'mature',         name:'Dân Trưởng Thành',      icon:'🧓',  team:'village' },
  { id:'lycan',          name:'Kẻ Săn Đuổi',          icon:'🌕',  team:'village' },
  { id:'priest',         name:'Linh Mục',             icon:'✝️',  team:'village' },
  { id:'avenger',        name:'Kẻ Báo Thù',           icon:'⚔️',  team:'village' },
  { id:'tracker',        name:'Kẻ Theo Dõi',          icon:'🔭',  team:'village' },
  { id:'gunsmith',       name:'Xạ Thủ',               icon:'🔫',  team:'village' },
  { id:'magistrate',     name:'Quan Tòa',             icon:'🔨',  team:'village' },
  { id:'gatekeeper',     name:'Kẻ Gác Cổng',          icon:'🚪',  team:'village' },
  { id:'lamb',           name:'Cừu Non',              icon:'🐑',  team:'village' },
  { id:'medium',         name:'Nhà Linh Hồn',          icon:'🕯️', team:'village' },
  { id:'wildchild',      name:'Dã Nhân',              icon:'🐾',  team:'village' },
  { id:'diplomat',       name:'Nhà Ngoại Giao',        icon:'🕊️', team:'village' },
  { id:'bountyhunter',   name:'Thợ Săn Tiền Thưởng',  icon:'🎖️', team:'village' },
  { id:'bloodymary',     name:'Bloody Mary',          icon:'🩷',  team:'village' },
  { id:'icewitch',       name:'Nữ Phù Thủy Băng Giá', icon:'❄️',  team:'village' },
  { id:'switcher',       name:'Kẻ Đánh Tráo',         icon:'🔄',  team:'village' },
  { id:'king',           name:'Vua',                  icon:'👑',  team:'village' },
  { id:'queencard',      name:'Hoàng Hậu',            icon:'👸',  team:'village' },
  { id:'hinter',         name:'Kẻ Gợi Ý',             icon:'💡',  team:'village' },
  // WOLF
  ...
  { id:'alpha',          name:'Sói Đầu Đàn',          icon:'🐺',  team:'wolf' },
  { id:'cursedwolf',     name:'Sói Nguyền',           icon:'🐺',  team:'wolf' },
  { id:'wolfseer',       name:'Sói Tiên Tri',         icon:'🐺',  team:'wolf' },
  { id:'hellhound',      name:'Sói Lửa',              icon:'🐺',  team:'wolf' },
  { id:'direwolf',       name:'Sói Cuồng Nộ',         icon:'🐺',  team:'wolf' },
  { id:'sorcerer',       name:'Sói Ma Thuật',         icon:'🐺',  team:'wolf' },
  { id:'hypnowolf',      name:'Sói Thao Túng',        icon:'🐺',  team:'wolf' },
  { id:'bigbadwolf',     name:'Sói Khổng Lồ',         icon:'🐺',  team:'wolf' },
  { id:'poisonwolf',     name:'Sói Độc',              icon:'🐺',  team:'wolf' },
  { id:'deserter',       name:'Kẻ Đào Ngũ',           icon:'🐺',  team:'wolf' },
  // THIRD PARTY
  { id:'serialkiller',   name:'Sát Nhân Hàng Loạt',  icon:'🔪',  team:'third' },
  { id:'joker',          name:'Kẻ Điên',              icon:'🤡',  team:'third' },
  { id:'traitor',        name:'Kẻ Phản Bội',          icon:'🎭',  team:'third' },
  { id:'fluteplayer',    name:'Chàng Thổi Sáo',       icon:'🪈',  team:'third' },
  { id:'hoodlum',        name:'Kẻ Thu Thập Linh Hồn', icon:'💀',  team:'third' },
  { id:'graverobber',    name:'Kẻ Trộm Mộ',           icon:'⛏️', team:'third' },
  { id:'challenger',     name:'Kẻ Thách Thức',        icon:'🎯',  team:'third' },
  { id:'blackmailer',    name:'Kẻ Tống Tiền',         icon:'📬',  team:'third' },
  { id:'doppelganger',   name:'Người Nhân Bản',        icon:'👥',  team:'third' },
  { id:'nighthunter',    name:'Kẻ Săn Đêm',           icon:'🌙',  team:'third' },
  { id:'assassin',       name:'Kẻ Ám Sát',            icon:'🗡️', team:'third' },
  // NEUTRAL
  { id:'copycat',        name:'Người Sao Chép',        icon:'🪞',  team:'neutral' },
  { id:'balancer',       name:'Kẻ Cân Bằng',          icon:'⚖️', team:'neutral' },
  { id:'survivor',       name:'Kẻ Sống Sót',           icon:'🛡️', team:'neutral' },
];
